export module vw.sync:resource_tracker;
import std3rd;
import vulkan3rd;
import :interval_set;
...
class ResourceTracker {
  public:
    ...
    // Test accessors
    const auto &pending_buffer_barriers() const {
        return m_pending_buffer_barriers;
    }
    const auto &pending_image_barriers() const {
        return m_pending_image_barriers;
    }
    const auto &pending_memory_barriers() const {
        return m_pending_memory_barriers;
    }
    const auto &buffer_states() const { return m_buffer_states; }
    const auto &image_states() const { return m_image_states; }
