...
// ============================================================================
// HemisphereSamples generation tests
// ============================================================================

TEST(RandomSamplingTest, GenerateHemisphereSamplesValuesInRange) {
    auto samples = vw::generate_hemisphere_samples();

    for (std::size_t i = 0; i < vw::HEMISPHERE_SAMPLE_COUNT; ++i) {
...
TEST(RandomSamplingTest, GenerateHemisphereSamplesReproducibleWithSeed) {
...
TEST(RandomSamplingTest, GenerateHemisphereSamplesDifferentWithDifferentSeed) {
    auto samples1 = vw::generate_hemisphere_samples(42);
...
// ============================================================================
// HemisphereSamplesBuffer tests
// ============================================================================

TEST(RandomSamplingTest, CreateHemisphereSamplesBuffer) {
    ...
    EXPECT_EQ(buffer.size_bytes(), sizeof(vw::HemisphereSamples));
}

TEST(RandomSamplingTest, HemisphereSamplesBufferContainsValidData) {
    auto &gpu = vw::tests::create_gpu();
...
TEST(RandomSamplingTest, HemisphereSamplesBufferReproducibleWithSeed) {
    auto &gpu = vw::tests::create_gpu();
...
TEST(RandomSamplingTest, ConstantsHaveExpectedValues) {
    EXPECT_EQ(vw::HEMISPHERE_SAMPLE_COUNT, 4096);
