export module advanced:ambient_occlusion_pass;
import app;

export enum class AOPassSlot {
 ...
 * calls.
 */
export class AmbientOcclusionPass : public vw::ScreenSpacePass<AOPassSlot> {
  public:
    ...
    uint32_t get_frame_count() const { return m_total_frame_count; }
